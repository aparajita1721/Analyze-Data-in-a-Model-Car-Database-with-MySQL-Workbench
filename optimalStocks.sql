...
HAVING (products.quantityInStock - COALESCE(SUM(orderdetails.quantityOrdered), 0)) < 3000 AND (products.quantityInStock - COALESCE(SUM(orderdetails.quantityOrdered), 0))>500
